package com.studio.flink.table;
...
//        tableEnv.executeSql(createDDL);
        ...
        // 使用API创建表
        tableEnv.createTemporaryTable("clickTable", TableDescriptor.forConnector("filesystem")
        ...
        tableEnv.executeSql("desc clickTable").print();
