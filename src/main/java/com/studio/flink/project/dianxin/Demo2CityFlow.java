...
public class Demo2CityFlow {
    public static void main(String[] args) throws Exception {
        ...
        // 统计人流量
        SingleOutputStreamOperator<Tuple2<String, Integer>> cityCountDS = keyedStream.process(new KeyedProcessFunction<String, Tuple2<String, String>, Tuple2<String, Integer>>() {
            /**
             * map 状态 -- 去重
